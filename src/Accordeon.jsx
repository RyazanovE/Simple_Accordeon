  ...
  return (
    <div className="w-[30vw]  bg-slate-100 flex flex-col">
      <button
        ...
        className={
<<<<<<< HEAD
          " z-10 py-[10px] bg-slate-400 hover:bg-slate-300 transition-color duration-100 text-[18px] text-white hover:text-slate-400"
        }
      >
=======
...
>>>>>>> 7c793a304f3a52cd072a2e9d34ad5a6ad8ee9e0d
        {title}
        <svg
